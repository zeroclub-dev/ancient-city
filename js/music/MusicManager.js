...
class MusicManager {
  ...
  async initMusicFiles() {
    // Use the full list of uploaded music files
    const musicFiles = [
      "Freed From Desire-129.mp3",
      "Give Me Everything-129.mp3",
      "Habits (Stay High)-121.mp3",
      "Heads Will Roll-132.mp3",
      "Heaven Takes You Home-125.mp3",
      "How Deep Is Your Love-122.mp3",
      "I Follow Rivers-122.mp3",
      "A Sky Full of Stars-125.mp3",
      "The Less I Know The Better (Club Edit)-128.mp3",
      "Turn On The Lights again.. (feat. Future)-132.mp3",
      "Scream & Shout-130.mp3",
      "SI NO ES CONTIGO-100.mp3",
      "Sleepless-126.mp3",
      "Una Noche En Medellin-100.mp3",
      "Starships-125.mp3",
      "Stereo Love-128.mp3",
      "Tears-127.mp3",
      "The Days NOTION Remix-138.mp3",
      "Clarity-128.mp3",
      "Latch-122.mp3",
      "Messy-134.mp3",
      "Move-120.mp3",
      "Never Be Like You-120.mp3",
      "Prada-142.mp3",
      "Pursuit Of Happiness-128.mp3",
      "Relax My Eyes-132.mp3",
      "Believe Me-125.mp3",
      "Bulletproof-123.mp3",
      "Chanel-114.mp3",
      "Cola-122.mp3",
